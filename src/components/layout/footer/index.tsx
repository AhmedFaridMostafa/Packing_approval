...
const Footer = async () => {
  ...
  return (
    <footer className="border-border bg-surface-container-lowest section-container mt-auto border-t py-12">
      ...
      <div className="border-border mt-10 flex flex-col items-center justify-between gap-3 border-t pt-6 sm:flex-row">
        <p className="text-caption text-on-surface-variant">{t("copyright")}</p>
