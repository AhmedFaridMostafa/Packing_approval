...
const VerificationEmail = ({ user, url, locale }: VerificationEmailProps) => {
  const messages = createTranslator({
    locale,
    messages: locale === "en" ? enMessages : arMessages,
    namespace: "VerificationEmail",
  });
...
VerificationEmail.PreviewProps = {
  ...
  url: "https://example.com/verify-email?token=abcdef1234567890",
  locale: "en",
};
